...
@Injectable()
export class CloludBookListServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getPaged(filterText: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfCloludBookListListDto> {
        let url_ = this.baseUrl + "/api/services/app/CloludBookList/GetPaged?";
        if (filterText !== undefined)
            url_ += "FilterText=" + encodeURIComponent("" + filterText) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfCloludBookListListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfCloludBookListListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetPaged(response: HttpResponseBase): Observable<PagedResultDtoOfCloludBookListListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfCloludBookListListDto.fromJS(resultData200) : new PagedResultDtoOfCloludBookListListDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfCloludBookListListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getById(id: number | null | undefined): Observable<CloludBookListListDto> {
        let url_ = this.baseUrl + "/api/services/app/CloludBookList/GetById?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<CloludBookListListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<CloludBookListListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetById(response: HttpResponseBase): Observable<CloludBookListListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? CloludBookListListDto.fromJS(resultData200) : new CloludBookListListDto();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CloludBookListListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<GetCloludBookListForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/CloludBookList/GetForEdit?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetCloludBookListForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetCloludBookListForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<GetCloludBookListForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetCloludBookListForEditOutput.fromJS(resultData200) : new GetCloludBookListForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status === 401) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetCloludBookListForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrUpdate(input: CreateOrUpdateCloludBookListInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CloludBookList/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CloludBookList/Delete?";
        if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    batchDelete(input: number[] | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CloludBookList/BatchDelete";
        url_ = url_.replace(/[?&]$/, "");
...
export class PagedResultDtoOfCloludBookListListDto implements IPagedResultDtoOfCloludBookListListDto {
    totalCount: number | undefined;
    items: CloludBookListListDto[] | undefined;

    constructor(data?: IPagedResultDtoOfCloludBookListListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(CloludBookListListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfCloludBookListListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfCloludBookListListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfCloludBookListListDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfCloludBookListListDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfCloludBookListListDto {
    totalCount: number | undefined;
    items: CloludBookListListDto[] | undefined;
}

export class CloludBookListListDto implements ICloludBookListListDto {
    ...
    constructor(data?: ICloludBookListListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CloludBookListListDto {
        data = typeof data === 'object' ? data : {};
        let result = new CloludBookListListDto();
        result.init(data);
        return result;
    }
...
export interface ICloludBookListListDto {
    name: string | undefined;
    intro: string | undefined;
    creationTime: moment.Moment | undefined;
    creatorUserId: number | undefined;
...
export class GetCloludBookListForEditOutput implements IGetCloludBookListForEditOutput {
    ...
    static fromJS(data: any): GetCloludBookListForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetCloludBookListForEditOutput();
        result.init(data);
        return result;
    }
    ...
    clone(): GetCloludBookListForEditOutput {
        const json = this.toJSON();
        let result = new GetCloludBookListForEditOutput();
        result.init(json);
        return result;
...
export class CloludBookListEditDto implements ICloludBookListEditDto {
    ...
    constructor(data?: ICloludBookListEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CloludBookListEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new CloludBookListEditDto();
        result.init(data);
        return result;
    }
...
export interface ICloludBookListEditDto {
    id: number | undefined;
    name: string | undefined;
    intro: string | undefined;
}
...
export class CreateOrUpdateCloludBookListInput implements ICreateOrUpdateCloludBookListInput {
    ...
    constructor(data?: ICreateOrUpdateCloludBookListInput) {
        ...
        if (!data) {
            this.cloludBookList = new CloludBookListEditDto();
        }
    }
    ...
    static fromJS(data: any): CreateOrUpdateCloludBookListInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrUpdateCloludBookListInput();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateOrUpdateCloludBookListInput {
        const json = this.toJSON();
        let result = new CreateOrUpdateCloludBookListInput();
        result.init(json);
        return result;
